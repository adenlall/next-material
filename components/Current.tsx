...
export default function Current() {
    return <Link href={"/projects/travelo"} className="md:w-1/2 w-full h-auto rounded-box secondary-container flex flex-col gap-2 p-4">
        ...
        <p className="m-0 pl-4 ">
            <strong className="underline mx-1">Travelo</strong> - <span className="mx-1">open source</span>
