                ...
                <div className="flex md:flex-row flex-col gap-4 items-stretch justify-center">
                    <article className="page h-[23em] bottom active medium middle-align md:w-1/2 w-full">
                        <div className="flex h-full flex-col">
                            <h1 className="text-start">Travelo</h1>
                            ...
                            <nav className="md:m-0 m-auto">
                                <a target="_blank" href="https://github.com/adenlall/travelo">
            ...
            <div className="secondary-container rounded-t-box">
                <div className="container m-auto mt-16 ">
                    <div className="w-full p-4 py-8 text-lg min-h-[15em]">
                        ...
                        <p>
                            Travelo is designed for adventurous travelers seeking companionship
                        ...
                        <div className="flex md:flex-row flex-col gap-6 my-4">
                            ...
                            <p className="md:w-1/2 w-full indent-8">
                                ...
                                <br />
                                <strong>Travelo</strong> distinguishes itself by fostering community and connection.
                                <strong>Travelo</strong> connects travelers with potential trip companions and local guides,
                        ...
                        <div className="flex md:flex-row flex-col-reverse gap-6 my-4">
                            <p className="md:w-1/2 w-full indent-8">
                                While <strong>Travelo</strong> connects travelers with potential
                        ...
                        <p>
                            Travelo's technical stack includes a Relay-compliant
                        ...
                        <p>
                            ...
                            especially in a platform like Travelo where users might
                            ...
                            <ul className="list-disc">
                                ...
                                <li>
                                    ...
                                    <p className="pl-4">
                                        ...
                                        good fit for a growing platform like Travelo.
                                    </p>
                                </li>
                                <li>
